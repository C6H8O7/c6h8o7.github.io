...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5376592,
    DYNAMIC_BASE = 5376592,
    DYNAMICTOP_PTR = 133520;
...
var ___em_js__sapp_js_hook_beforeunload = Module["___em_js__sapp_js_hook_beforeunload"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__sapp_js_hook_beforeunload"].apply(null, arguments)
};
